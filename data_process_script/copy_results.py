...
file_list, infer_list = name_to_file_list(downtown_test_file_name)
...
file_list, infer_list = name_to_file_list(parkway_test_file_name)
copyfile(file_list, src_path, des_path)
copyfile(infer_list, src_path, des_path)
